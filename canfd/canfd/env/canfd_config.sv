`ifndef _CANFD_CONFIG_SV_
`define _CANFD_CONFIG_SV_

//=========================================================================
// canfd_config: 全局验证环境配置类
//   集中管理所有子组件的配置参数
//   通过 uvm_config_db#(canfd_config)::set/get 在层次间传递
//=========================================================================
class canfd_config extends uvm_object;
	...
	`uvm_object_utils_begin(canfd_config)
	...
	function new(string name="canfd_config");
		super.new(name);
	endfunction : new

endclass : canfd_config
