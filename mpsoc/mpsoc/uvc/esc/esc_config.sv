`ifndef _ESC_CONFIG_SV_
`define _ESC_CONFIG_SV_

//=========================================================================
// esc_config: 全局验证环境配置类
//   集中管理所有子组件的配置参数
//   通过 uvm_config_db#(esc_config)::set/get 在层次间传递
//=========================================================================
class esc_config extends uvm_object;
	...
	`uvm_object_utils_begin(esc_config)
	...
	function new(string name="esc_config");
		super.new(name);
	endfunction : new
