`ifndef _GMAC_CONFIG_SV_
`define _GMAC_CONFIG_SV_

//=========================================================================
// gmac_config: 全局验证环境配置类
//   集中管理所有子组件的配置参数
//   通过 uvm_config_db#(gmac_config)::set/get 在层次间传递
//=========================================================================
class gmac_config extends uvm_object;
	...
	`uvm_object_utils_begin(gmac_config)
	...
	function new(string name="gmac_config");
		super.new(name);
	endfunction : new

endclass : gmac_config
