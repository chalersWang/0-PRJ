...
//=========================================================================
class sysctrl_trans extends uvm_sequence_item;

	// ===== 随机化变量（对应 DUT 接口信号） =====
	rand logic         i_pad_clk;           // 1-bit
	rand logic         i_pad_rst_b;         // 1-bit
	rand logic [1:0] i_pad_boot_mode;     // [1:0]
	rand logic         i_pad_host_if_mode;  // 1-bit
	rand logic         i_pad_bypass_secure; // 1-bit
	...
	`uvm_object_utils_begin(sysctrl_trans)
		`uvm_field_int(i_pad_clk, UVM_ALL_ON)
		`uvm_field_int(i_pad_rst_b, UVM_ALL_ON)
		`uvm_field_int(i_pad_boot_mode, UVM_ALL_ON)
		`uvm_field_int(i_pad_host_if_mode, UVM_ALL_ON)
	...
	//     end
	//     super.do_copy(rhs);
	//     this.i_pad_clk = rhs_.i_pad_clk;
	//     this.i_pad_rst_b = rhs_.i_pad_rst_b;
	//     this.i_pad_boot_mode = rhs_.i_pad_boot_mode;
	//     this.i_pad_host_if_mode = rhs_.i_pad_host_if_mode;
	//     this.i_pad_bypass_secure = rhs_.i_pad_bypass_secure;
	//     this.o_pad_pn_sync = rhs_.o_pad_pn_sync;
	//     this.i_pad_test_mode = rhs_.i_pad_test_mode;
	// endfunction
