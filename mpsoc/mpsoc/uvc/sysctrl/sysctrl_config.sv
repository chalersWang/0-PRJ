`ifndef _SYSCTRL_CONFIG_SV_
`define _SYSCTRL_CONFIG_SV_

//=========================================================================
// sysctrl_config: 全局验证环境配置类
//   集中管理所有子组件的配置参数
//   通过 uvm_config_db#(sysctrl_config)::set/get 在层次间传递
//=========================================================================
class sysctrl_config extends uvm_object;
	...
	`uvm_object_utils_begin(sysctrl_config)
	...
	function new(string name="sysctrl_config");
		super.new(name);
	endfunction : new

endclass : sysctrl_config
