`ifndef _MIIPHY_CONFIG_SV_
`define _MIIPHY_CONFIG_SV_

//=========================================================================
// miiphy_config: 全局验证环境配置类
//   集中管理所有子组件的配置参数
//   通过 uvm_config_db#(miiphy_config)::set/get 在层次间传递
//=========================================================================
class miiphy_config extends uvm_object;
	...
	`uvm_object_utils_begin(miiphy_config)
	...
	function new(string name="miiphy_config");
		super.new(name);
	endfunction : new

endclass : miiphy_config
