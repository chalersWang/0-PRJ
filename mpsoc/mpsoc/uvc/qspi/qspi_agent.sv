`ifndef _QSPI_AGENT_SV_
`define _QSPI_AGENT_SV_

//=========================================================================
// qspi_agent: qspi UVC 的顶层 agent
...
class qspi_agent extends uvm_agent;
	...
	`uvm_component_utils_begin(qspi_agent)
		...
		`uvm_field_object(qspi_drv,  UVM_ALL_ON)
		`uvm_field_object(qspi_mon,  UVM_ALL_ON)
		`uvm_field_object(qspi_seqr, UVM_ALL_ON)
	`uvm_component_utils_end

	function new(string name="qspi_agent",uvm_component parent=null);
	...
	virtual function void build_phase(uvm_phase phase);
		...
		if(is_active==UVM_ACTIVE)begin
		    qspi_drv  = qspi_driver::type_id::create("qspi_drv", this);
		    qspi_seqr = qspi_sequencer::type_id::create("qspi_seqr", this);
		end
	...
	virtual function void connect_phase(uvm_phase phase);
		...
		if(is_active==UVM_ACTIVE)begin
		    qspi_drv.seq_item_port.connect(qspi_seqr.seq_item_export);
		    // rsp_port 用于 driver→sequencer 的响应回传
		    qspi_drv.rsp_port.connect(qspi_seqr.rsp_export);
		end
