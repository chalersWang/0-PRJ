`ifndef _QSPI_CONFIG_SV_
`define _QSPI_CONFIG_SV_

//=========================================================================
// qspi_config: 全局验证环境配置类
//   集中管理所有子组件的配置参数
//   通过 uvm_config_db#(qspi_config)::set/get 在层次间传递
//=========================================================================
class qspi_config extends uvm_object;
	...
	`uvm_object_utils_begin(qspi_config)
	...
	function new(string name="qspi_config");
		super.new(name);
	endfunction : new

endclass : qspi_config
