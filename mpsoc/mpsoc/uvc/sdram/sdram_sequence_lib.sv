`ifndef _SDRAM_SEQUENCE_LIB_SV_
`define _SDRAM_SEQUENCE_LIB_SV_

//=========================================================================
// sdram_base_sequence: sdram UVC 的基类 sequence
//   继承自 uvm_sequence，所有 sdram 相关 sequence 应继承此类
//=========================================================================
class sdram_base_sequence extends uvm_sequence#(sdram_trans);
	...
	virtual task body();
		...
		//
		// 方式3: 手动控制（需要精细控制时）
		// req = sdram_trans::type_id::create("req");
		// start_item(req);
...
//=========================================================================
// sdram_demo_sequence: 示例 sequence
//   生成单笔 transaction 并发送
//=========================================================================
class sdram_demo_sequence extends sdram_base_sequence;
	`uvm_object_utils(sdram_demo_sequence)
	function new(string name="sdram_demo_sequence");
		super.new(name);
	endfunction
	virtual task body();
