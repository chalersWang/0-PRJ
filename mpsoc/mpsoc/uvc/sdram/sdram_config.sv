`ifndef _SDRAM_CONFIG_SV_
`define _SDRAM_CONFIG_SV_

//=========================================================================
// sdram_config: 全局验证环境配置类
//   集中管理所有子组件的配置参数
//   通过 uvm_config_db#(sdram_config)::set/get 在层次间传递
//=========================================================================
class sdram_config extends uvm_object;
	...
	`uvm_object_utils_begin(sdram_config)
	...
	function new(string name="sdram_config");
		super.new(name);
	endfunction : new

endclass : sdram_config
