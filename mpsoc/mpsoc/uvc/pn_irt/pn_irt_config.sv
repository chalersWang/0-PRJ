`ifndef _PN_IRT_CONFIG_SV_
`define _PN_IRT_CONFIG_SV_

//=========================================================================
// pn_irt_config: 全局验证环境配置类
//   集中管理所有子组件的配置参数
//   通过 uvm_config_db#pn_irt_config::set/get 在层次间传递
//=========================================================================
class pn_irt_config extends uvm_object;
	...
	`uvm_object_utils_begin(pn_irt_config)
	...
	function new(string name="pn_irt_config");
		super.new(name);
	endfunction : new

endclass : pn_irt_config
