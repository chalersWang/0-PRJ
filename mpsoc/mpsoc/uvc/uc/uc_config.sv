`ifndef _UC_CONFIG_SV_
`define _UC_CONFIG_SV_

//=========================================================================
// uc_config: 全局验证环境配置类
//   集中管理所有子组件的配置参数
//   通过 uvm_config_db#uc_config::set/get 在层次间传递
//=========================================================================
class uc_config extends uvm_object;
	...
	`uvm_object_utils_begin(uc_config)
	...
	function new(string name="uc_config");
		super.new(name);
	endfunction : new
