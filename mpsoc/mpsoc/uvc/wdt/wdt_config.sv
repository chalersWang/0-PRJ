`ifndef _WDT_CONFIG_SV_
`define _WDT_CONFIG_SV_

//=========================================================================
// wdt_config: 全局验证环境配置类
//   集中管理所有子组件的配置参数
//   通过 uvm_config_db#(wdt_config)::set/get 在层次间传递
//=========================================================================
class wdt_config extends uvm_object;
	...
	`uvm_object_utils_begin(wdt_config)
	...
	function new(string name="wdt_config");
		super.new(name);
	endfunction : new
