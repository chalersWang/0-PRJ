`ifndef _SWITCH_CONFIG_SV_
`define _SWITCH_CONFIG_SV_

//=========================================================================
// switch_config: 全局验证环境配置类
//   集中管理所有子组件的配置参数
//   通过 uvm_config_db#(switch_config)::set/get 在层次间传递
//=========================================================================
class switch_config extends uvm_object;
	...
	`uvm_object_utils_begin(switch_config)
	...
	function new(string name="switch_config");
		super.new(name);
	endfunction : new

endclass : switch_config
