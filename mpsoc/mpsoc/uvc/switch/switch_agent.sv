`ifndef _SWITCH_AGENT_SV_
`define _SWITCH_AGENT_SV_

//=========================================================================
// switch_agent: switch UVC 的顶层 agent
...
class switch_agent extends uvm_agent;
	...
	`uvm_component_utils_begin(switch_agent)
		...
		`uvm_field_object(switch_drv,  UVM_ALL_ON)
		`uvm_field_object(switch_mon,  UVM_ALL_ON)
	...
	virtual function void build_phase(uvm_phase phase);
		...
		if(is_active==UVM_ACTIVE)begin
		    switch_drv  = switch_driver::type_id::create("switch_drv", this);
		    switch_seqr = switch_sequencer::type_id::create("switch_seqr", this);
		end
		switch_mon = switch_monitor::type_id::create("switch_mon", this);
	...
	virtual function void connect_phase(uvm_phase phase);
		...
		if(is_active==UVM_ACTIVE)begin
		    switch_drv.seq_item_port.connect(switch_seqr.seq_item_export);
		    // rsp_port 用于 driver→sequencer 的响应回传
		    switch_drv.rsp_port.connect(switch_seqr.rsp_export);
		end
