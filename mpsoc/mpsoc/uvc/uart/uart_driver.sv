`ifndef _UART_DRIVER_SV_
`define _UART_DRIVER_SV_

//=========================================================================
// uart_driver: 将 transaction 驱动到 DUT 接口（时序级）
...
class uart_driver extends uvm_driver#(uart_trans);
	...
	virtual function void build_phase(uvm_phase phase);
		...
		if(!uvm_config_db#(virtual uart_vif)::get(this,"","uart_vif",vif))
		    `uvm_fatal("uart_driver","virtual interface must be set for it!!!")
	...
	*/
	...
	virtual task reset_phase(uvm_phase phase);
		...
		vif.i_pad_uart0_sin = 'd0;
		vif.o_pad_uart0_sout = 'd0;
	...
	//=========================================================================
	virtual task driver_one_pkt(uart_trans tr);
...
endclass : uart_driver
	...
	//=========================================================================
	// uart_driver_callback: Driver 回调基类
	//   用户可继承此类扩展 driver 行为（如错误注入、协议检查等）
	//   使用方式：
	//     class my_driver_cb extends uart_driver_callback;
	...
	class uart_driver_callback extends uvm_callback;
		...
		virtual function void pre_driver(uart_driver drv, uart_trans tr);
		endfunction
