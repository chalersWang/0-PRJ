`ifndef _UART_TRANS_SV_
`define _UART_TRANS_SV_

//=========================================================================
// uart_trans: uart UVC 的 Transaction 类
//
// 【UVM Field 机制说明】
...
class uart_trans extends uvm_sequence_item;
	...
	// ===== 随机化变量（对应 DUT 接口信号） =====
	rand logic         i_pad_uart0_sin;     // 1-bit
	rand logic         o_pad_uart0_sout;    // 1-bit
	...
	`uvm_object_utils_begin(uart_trans)
		`uvm_field_int(i_pad_uart0_sin, UVM_ALL_ON)
		`uvm_field_int(o_pad_uart0_sout, UVM_ALL_ON)
	...
	//     end
	//     super.do_copy(rhs);
	//     this.i_pad_uart0_sin = rhs_.i_pad_uart0_sin;
	//     this.o_pad_uart0_sout = rhs_.o_pad_uart0_sout;
	// endfunction
