`ifndef _EFUSE_CONFIG_SV_
`define _EFUSE_CONFIG_SV_

//=========================================================================
// efuse_config: 全局验证环境配置类
//   集中管理所有子组件的配置参数
//   通过 uvm_config_db#(efuse_config)::set/get 在层次间传递
//=========================================================================
class efuse_config extends uvm_object;
	...
	`uvm_object_utils_begin(efuse_config)
	...
	function new(string name="efuse_config");
		super.new(name);
	endfunction : new

endclass : efuse_config
