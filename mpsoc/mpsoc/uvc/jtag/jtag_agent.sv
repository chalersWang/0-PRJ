`ifndef _JTAG_AGENT_SV_
`define _JTAG_AGENT_SV_

//=========================================================================
// jtag_agent: jtag UVC 的顶层 agent
...
class jtag_agent extends uvm_agent;
	...
	`uvm_component_utils_begin(jtag_agent)
		...
		`uvm_field_object(jtag_drv,  UVM_ALL_ON)
		`uvm_field_object(jtag_mon,  UVM_ALL_ON)
	...
	virtual function void connect_phase(uvm_phase phase);
		...
		if(is_active==UVM_ACTIVE)begin
		    ...
		    jtag_drv.rsp_port.connect(jtag_seqr.rsp_export);
		end
