`ifndef _TIM_CONFIG_SV_
`define _TIM_CONFIG_SV_

//=========================================================================
// tim_config: 全局验证环境配置类
//   集中管理所有子组件的配置参数
//   通过 uvm_config_db#(tim_config)::set/get 在层次间传递
//=========================================================================
class tim_config extends uvm_object;
	...
	`uvm_object_utils_begin(tim_config)
	...
	function new(string name="tim_config");
		super.new(name);
	endfunction : new
