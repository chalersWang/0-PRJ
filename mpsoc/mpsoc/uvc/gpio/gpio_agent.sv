`ifndef _GPIO_AGENT_SV_
`define _GPIO_AGENT_SV_

//=========================================================================
// gpio_agent: gpio UVC 的顶层 agent
...
class gpio_agent extends uvm_agent;
	...
	`uvm_component_utils_begin(gpio_agent)
		...
		`uvm_field_object(gpio_drv,  UVM_ALL_ON)
		`uvm_field_object(gpio_mon,  UVM_ALL_ON)
	...
	virtual function void build_phase(uvm_phase phase);
		...
		if(is_active==UVM_ACTIVE)begin
		    ...
		    gpio_seqr = gpio_sequencer::type_id::create("gpio_seqr", this);
		end
	...
	virtual function void connect_phase(uvm_phase phase);
		...
		if(is_active==UVM_ACTIVE)begin
		    ...
		    gpio_drv.rsp_port.connect(gpio_seqr.rsp_export);
		end
