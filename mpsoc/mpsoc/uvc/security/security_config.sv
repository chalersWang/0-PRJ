`ifndef _SECURITY_CONFIG_SV_
`define _SECURITY_CONFIG_SV_
...
class security_config extends uvm_object;
	...
	`uvm_object_utils_begin(security_config)
	...
	function new(string name="security_config");
		super.new(name);
	endfunction : new

endclass : security_config
